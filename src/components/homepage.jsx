    ...
    <>
      <div className='w-screen h-full bg-black text-white p-10'>
        <AnimatedContent
          ...
          delay={0}
        >
          <div className='p-10 md:p-20 flex flex-col gap-4 justify-center items-center'>
            <div className='p-5 text-xl md:text-3xl'>
              <span className='text-3xl md:text-4xl font-semibold'>
                Welcome,
              </span>{' '}
              to the one and only,
            </div>
            <div className='pb-10 text-xl md:text-2xl'>Shop & React!</div>
          </div>
